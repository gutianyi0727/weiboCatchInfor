...
class Weibo:
    cookie = {"Cookie": "SCF=ArM_GLFFbImL2eDde-Td5a__I1e1ZWIc1xv85Yw5iYxPtYjzxsIbHtbv-up5ZjsskpR6eEAynCWVh_BTIVYGPig.; _T_WM=6c348ebdf8ed7cc22f1382abe122f816; MLOGIN=1; td_cookie=18446744070256711650; SUB=_2A2538aPHDeRhGeNK61YX8CbJyT-IHXVVHc2PrDV6PUJbkdBeLXDVkW1NSW-ZfgjLM1QEhT4nfTKq9RbQAuWeVDjg; SUHB=04WuztXfU6hAO_; SSOLoginState=1526059927"}  # 将your cookie替换成自己的cookie
...
def main():
    try:
        ...
        user_id = 3285884397  # 可以改成任意合法的用户id（爬虫的微博id除外）
